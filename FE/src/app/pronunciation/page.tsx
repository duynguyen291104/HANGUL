      ...
      <div className="flex">
        <aside className="hidden lg:flex flex-col gap-2 py-6 bg-[#f4f4ef] w-72 h-screen sticky left-0 top-0 text-[#72564c] font-['Plus_Jakarta_Sans'] text-sm font-semibold">
          ...
          <nav className="flex-grow flex flex-col gap-1 px-4">
            ...
            <Link href="/pronunciation" className="text-[#72564c] mx-0 py-3 px-4 rounded-lg flex items-center gap-3 bg-[#72564c] text-white transition-all active:scale-95">
              <div className="flex flex-col">
                <span className="font-bold text-xl">Pronunciation</span>
                <span className="text-xl opacity-80 font-normal">Speak & listen</span>
              </div>
            </Link>
