      ...
      <div className="flex">
        ...
        <div className="flex-1">
          <div className="px-[90px] py-12 max-w-7xl mx-auto">
            {/* Header Section */}
            <div className="mb-12">
              <div className="inline-flex items-center gap-2 bg-[#ffddb5] px-4 py-1.5 rounded-full mb-4">
                <span className="text-sm">⭐</span>
                <span className="text-[#2a1800] font-bold text-xs tracking-wider uppercase">Weekly Tournament</span>
              </div>
              <h1 className="font-['Plus_Jakarta_Sans'] text-5xl font-extrabold text-[#1a1c19] tracking-tight mb-4">The Otter Arena</h1>
              <p className="text-[#504441] max-w-lg leading-relaxed">
                ...
                {gameModes.map((mode) => (
                  ...
                  >
                    <div className="relative z-10 flex flex-col h-full">
                      <h3 className="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-2 text-[#1a1c19]">{mode.title}</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg mb-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#1a1c19]">Leaderboard</h2>
              ...
              <div className="space-y-4">
                {leaderboard.map((entry) => (
                  <div key={entry.rank} className="flex items-center gap-4 p-4 bg-[#f9f9f7] rounded-lg hover:shadow-md transition-shadow">
                    <div className="w-8 text-center font-['Plus_Jakarta_Sans'] font-black text-[#815300]">{entry.rank}</div>
                ...
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-[#72564c] to-[#8d6e63] text-white rounded-lg shadow-lg">
                  <div className="w-8 text-center font-['Plus_Jakarta_Sans'] font-black">{userRank.rank}</div>
              ...
              <div className="mt-8 bg-gradient-to-br from-[#815300] to-[#a26900] text-white p-6 rounded-lg relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <h4 className="font-['Plus_Jakarta_Sans'] text-lg font-bold mb-4">Master Calligrapher Otter Skin</h4>
