    ...
    <div className="min-h-screen bg-[#fafaf5] text-[#1a1c19]">
      ...
      <header className="bg-[#fafaf5]/80 backdrop-blur-xl flex justify-between items-center w-full px-10 py-4 sticky top-0 z-50 shadow-[0_20px_40px_rgba(43,22,15,0.06)] h-20">
        <div className="flex items-center gap-2">
          ...
          />
          <div className="text-2xl font-black text-[#72564c] tracking-tighter uppercase">
            HANGUL
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/login"
            className="px-6 py-2 text-[#72564c] font-bold tracking-tight hover:text-[#5b4137] transition"
          >
            Đăng nhập
          </Link>
          <Link
            href="/register"
            className="px-6 py-2 bg-gradient-to-r from-[#72564c] to-[#8d6e63] text-white rounded-xl font-bold hover:from-[#5b4137] hover:to-[#72564c] transition-all shadow-lg"
          >
            Đăng ký
          </Link>
        </div>
      ...
      <main>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-12 overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto mb-16">
            <h1 className="text-5xl md:text-7xl font-extrabold text-[#72564c] tracking-tight mb-6 leading-tight">
              Korean Learning <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="bg-gradient-to-r from-[#72564c] to-[#8d6e63] text-white px-10 py-5 rounded-xl font-bold text-lg shadow-xl hover:scale-105 transition-transform active:scale-95"
              >
                Start Learning for Free
              </Link>
              <button
                onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}
                className="bg-[#e8e8e3] text-[#504441] px-10 py-5 rounded-xl font-bold text-lg hover:bg-[#e3e3de] transition-colors active:scale-95"
              >
                See the Arena
              </button>
            </div>
          ...
          <div className="relative z-20 w-full max-w-6xl h-[400px] flex items-end justify-center gap-4 px-4">
            ...
            <div className="relative group w-1/3 max-w-[320px] -mx-4 z-10">
              <div className="absolute -top-24 left-1/2 -translate-x-1/2 bg-[#fafaf5]/80 backdrop-blur-md px-8 py-4 rounded-2xl shadow-xl border border-white/50 opacity-100">
                <p className="text-lg font-black text-[#72564c] uppercase tracking-tighter">Ready to Dive In?</p>
              </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="mb-16">
            <span className="font-bold text-[#72564c] tracking-widest uppercase text-sm">Our Philosophy</span>
            <h2 className="text-4xl md:text-5xl font-black text-[#72564c] mt-4 tracking-tight">The Tactile Approach</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
            ...
            <div className="md:col-span-7 bg-[#f4f4ef] p-10 rounded-lg flex flex-col justify-between overflow-hidden relative group">
              <div>
                <h3 className="text-3xl font-bold text-[#72564c] mb-4">No Sterile Grids.</h3>
            ...
            <div className="md:col-span-5 bg-[#72564c] p-10 rounded-lg text-white flex flex-col justify-center relative">
              ...
              <h3 className="text-3xl font-bold mb-4">Mascot-Led Support</h3>
              ...
              <div className="absolute top-4 right-4 text-[#ffdbce] opacity-20 text-9xl font-black">02</div>
            </div>
            ...
            <div className="md:col-span-4 bg-[#c2ebe5] p-10 rounded-lg flex flex-col justify-end group">
              ...
              <h3 className="text-2xl font-bold text-[#406561] mb-2">Smart Progress</h3>
            ...
            <div className="md:col-span-8 bg-[#e8e8e3] p-10 rounded-lg flex items-center gap-8 group">
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-[#72564c] mb-2">Master the Script</h3>
              ...
              <div className="w-1/3 h-full rounded-2xl bg-white shadow-inner flex items-center justify-center">
                <span className="text-8xl font-black text-[#72564c]/10 group-hover:text-[#72564c] transition-colors">한</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="py-24 bg-[#f4f4ef]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-black text-[#72564c] tracking-tight mb-4">Your Learning Toolkit</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="bg-white p-8 rounded-xl hover:shadow-[0_20px_40px_rgba(43,22,15,0.06)] transition-all cursor-pointer border border-transparent hover:border-[#e4beb2] group">
                ...
                <h4 className="font-bold text-lg text-[#72564c] mb-2">Smart Quiz</h4>
              ...
              <div className="bg-white p-8 rounded-xl hover:shadow-[0_20px_40px_rgba(43,22,15,0.06)] transition-all cursor-pointer border border-transparent hover:border-[#a6cec9] group">
                ...
                <h4 className="font-bold text-lg text-[#406561] mb-2">Writing Pad</h4>
              ...
              <div className="bg-white p-8 rounded-xl hover:shadow-[0_20px_40px_rgba(43,22,15,0.06)] transition-all cursor-pointer border border-transparent hover:border-[#ffb957] group">
                ...
                <h4 className="font-bold text-lg text-[#815300] mb-2">Voice Lab</h4>
              ...
              <div className="bg-white p-8 rounded-xl hover:shadow-[0_20px_40px_rgba(43,22,15,0.06)] transition-all cursor-pointer border border-transparent hover:border-[#ffdad6] group">
                ...
                <h4 className="font-bold text-lg text-[#ba1a1a] mb-2">Lens Scan</h4>
              ...
              <div className="bg-white p-8 rounded-xl hover:shadow-[0_20px_40px_rgba(43,22,15,0.06)] transition-all cursor-pointer border border-transparent hover:border-[#72564c] group">
                ...
                <h4 className="font-bold text-lg text-[#72564c] mb-2">The Arena</h4>
        ...
        <section className="py-24 px-6 relative overflow-hidden">
          <div className="max-w-5xl mx-auto bg-[#8d6e63] rounded-3xl p-12 md:p-24 text-center relative z-10 overflow-hidden shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                href="/register"
                className="bg-white text-[#72564c] px-12 py-6 rounded-full font-bold text-xl shadow-xl hover:bg-[#c2ebe5] hover:scale-105 transition-all active:scale-95"
              >
                Start Learning for Free
              </Link>
      ...
      <footer className="bg-[#e8e8e3] py-16 px-8 mt-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="max-w-xs">
            <div className="text-2xl font-black text-[#72564c] tracking-tighter uppercase mb-6">
              HANGUL
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 w-full md:w-auto">
            <div className="flex flex-col gap-4">
              <h5 className="font-bold text-[#72564c]">Platform</h5>
            ...
            <div className="flex flex-col gap-4">
              <h5 className="font-bold text-[#72564c]">Resources</h5>
            ...
            <div className="flex flex-col gap-4">
              <h5 className="font-bold text-[#72564c]">Company</h5>
