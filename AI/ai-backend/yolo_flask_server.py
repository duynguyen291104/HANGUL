#!/usr/bin/env python3
"""YOLO Detection - Flask Server with MJPEG Streaming"""
...
print("=" * 70)
print("🎥 YOLO Detection - Flask Server (MJPEG Streaming)")
print("=" * 70)
    ...
    def generate():
        while True:
            if state.frame is not None:
                ...
                # Send blank frame while loading
...
if __name__ == '__main__':
    ...
    print("  GET  /api/yolo/config      - Get config")
    print("  POST /api/yolo/config      - Set config")
